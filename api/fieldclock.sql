...
CREATE TABLE `time_entries` (
  ...
  `work_order_id` int unsigned DEFAULT NULL,
  `status_label` enum('working','lunch','material_run','waiting','done') DEFAULT NULL,
  `cost_category` enum('direct_labor','paid_lunch','material_pickup','waiting_time','admin_photos','rework','day_end') DEFAULT NULL,
